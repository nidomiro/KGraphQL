...
class DocumentParserTest {
    ...
    fun `mutation selection set parsing`() {
        val map =
            graphParser.parseSelectionTree(("{createHero(name: \"Batman\", appearsIn: \"The Dark Knight\"){id name timestamp}}"))
        val expected = SelectionTree(
            argBranch(
                "createHero",
    ...
    fun `mutation nested selection set parsing`() {
        val map =
            graphParser.parseSelectionTree(("{createHero(name: \"Batman\", appearsIn: \"The Dark Knight\"){id name {real asHero}}}"))
        val expected = SelectionTree(
            argBranch(
                "createHero",
                args("name" to "\"Batman\"", "appearsIn" to "\"The Dark Knight\""),
