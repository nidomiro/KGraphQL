...
class IntrospectionSpecificationTest {
    ...
    fun `__typename field can be used to obtain type of object`(){
        ...
        val response = deserialize(schema.executeBlockingGetOne("{sample{string, __typename}}"))
    ...
    fun `__typename field cannot be used on scalars`(){
        ...
        invoking {
            schema.executeBlockingGetOne("{sample{string{__typename}}}")
    ...
    fun `field __schema is accessible from the type of the root of a query operation`(){
        ...
        val response = deserialize(schema.executeBlockingGetOne("{__schema{queryType{fields{name}}}}"))
    ...
    fun `field __types is accessible from the type of the root of a query operation`(){
        ...
        val response =
            deserialize(schema.executeBlockingGetOne("{__type(name: \"String\"){kind, name, description}}"))
    ...
    fun `__typename returns actual type of object`(){
        ...
        val response = deserialize(schema.executeBlockingGetOne("{interface{value, __typename ... on Face{value2}}}"))
    ...
    fun `introspection field __typename must not leak into schema introspection`(){
        ...
        val map = deserialize(schema.executeBlockingGetOne(INTROSPECTION_QUERY))
    ...
    fun `introspection shouldn't contain LookupSchema nor SchemaProxy`() {
        unionSchema.executeBlockingGetOne(INTROSPECTION_QUERY).run {
    ...
    fun `query type should have non null, empty interface list`(){
        ...
        val response = deserialize(schema.executeBlockingGetOne("{__schema{queryType{interfaces{name}}}}"))
    ...
    fun `__Directive introspection type should have onField, onFragment, onOperation fields`(){
        ...
        val response =
            deserialize(schema.executeBlockingGetOne("{__schema{directives{name, onField, onFragment, onOperation}}}"))
